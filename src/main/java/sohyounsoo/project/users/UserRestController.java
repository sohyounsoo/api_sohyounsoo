...
import sohyounsoo.project.errors.UnauthorizedException;
import sohyounsoo.project.security.Jwt;
import sohyounsoo.project.security.JwtAuthentication;
import sohyounsoo.project.security.JwtAuthenticationToken;
...
import static sohyounsoo.project.utils.ApiUtils.ApiResult;
import static sohyounsoo.project.utils.ApiUtils.success;
  ...
  public ApiResult<LoginResult> login(
    ...
    try {
      Authentication authentication = authenticationManager.authenticate(
        new JwtAuthenticationToken(request.getAccountId(), request.getPassword())
      );
