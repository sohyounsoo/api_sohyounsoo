...
> 힌트: @ControllerAdvice 어노테이션이 적용되있는 errors.sohyounsoo.callbus.GeneralExceptionHandler 구현을 참고하세요.
...
> 힌트: users.sohyounsoo.callbus.UserRestController 구현을 참고하세요.
...
> 힌트: 페이징 파라미터 (offset, size) 처리를 위해 web.configures.sohyounsoo.callbus.SimplePageRequestHandlerMethodArgumentResolver 클래스 완성이 필요합니다.
